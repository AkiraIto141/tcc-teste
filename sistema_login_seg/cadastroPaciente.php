...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $verifica = $pdo->prepare("SELECT id FROM paciente WHERE email = ?");
        ...
        if ($verifica->rowCount() > 0) {
            ...
            $stmt = $pdo->prepare('INSERT INTO paciente (email,senha,nome,cpf,telefone,data_de_nascimento) VALUES (?,?,?,?,?,?)');
            $stmt->execute([$email, $senha, $nome, $cpf, $telefone, $dataNascimento]);
    ...
    <div class="cadastro-container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" name="data_nascimento" id="usuario" required>
            </div>
            <div class="form-group">
        ...
        <div class="register-link">
            <a href="loginPaciente.php">Voltar para Login</a>
        </div>
    </div>
</body>
